			...
			<div className={className}>
				...
				>
					<input
						...
						ref={ref}
						className={cn(
							"w-full rounded-lg border-[1.5px] bg-transparent outline-none transition focus:border-primary disabled:cursor-default disabled:bg-gray-2 data-[active=true]:border-primary dark:border-dark-3 dark:bg-dark-2 dark:focus:border-primary dark:disabled:bg-dark dark:data-[active=true]:border-primary",
							type === "file"
								? getFileStyles(props.fileStyleVariant!)
								: "px-5.5 pr-12.5 py-3 text-dark placeholder:text-dark-6 dark:text-white",
					...
					{isPassword && (
						<div
							className="absolute mt-[1px] right-8 top-1/2 -translate-y-1/2 cursor-pointer"
